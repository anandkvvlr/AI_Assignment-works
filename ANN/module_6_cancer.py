...
# load data set
df = pd.read_csv('F:/AI assignment/AI assignment/Module 6/A6_Datasets/breast_cancer.csv')
...
# changing ouput diagnosis column from char to integer
...
#fit the model
model = model.fit(x_train,y_train,epochs=30,batch_size=16,validation_data=(x_valid, y_valid))
